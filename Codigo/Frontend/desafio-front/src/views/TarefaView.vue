            ...
            <div class="row">
                <div class="col">
                    <InputComponent label="Descrição" for-id="descricaoTarefa">
                        <textarea type="text" class="form-control" required v-model="descricao" style="height: 70px; resize: none;"/>
            ...
            <div class="row">
                <div class="col">
                    <InputComponent label="Descrição">
                        <textarea class="form-control" disabled style="height: 70px; resize: none;">{{ tarefa.descricao }} </textarea>
                    </InputComponent>
                </div>
            </div>
